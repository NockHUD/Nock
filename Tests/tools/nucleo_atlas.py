...
WANT = [
    ...
    # Settings window (2026-09-06): the sidebar's page glyphs and the chrome.
    ("sliders",    ["sliders-2", "sliders"]),
    ("rows",       ["menu-bars"]),
    ("bolt",       ["bolt-lightning", "circle-bolt"]),
    ("equalizer",  ["equalizer", "equalizer-2"]),
    ("pill",       ["pill", "pill-2"]),
    ("shield",     ["shield-check", "shield-2"]),
    ("skull",      ["skull"]),
    ("signal",     ["circle-signal"]),
    ("turn",       ["arrow-turn-right", "arrow-turn-right-2"]),
    ("cart",       ["cart-shopping"]),
    ("envelope",   ["envelope"]),
    ("keyboard",   ["keyboard-4"]),
    ("shirt",      ["t-shirt", "shirt"]),
    ("wrench",     ["wrench"]),
    ("flask",      ["flask", "test-tube"]),
    ("profiles",   ["profiles", "users-2"]),
    ("magnifier",  ["magnifier"]),
    ("lock",       ["lock"]),
    ("lockopen",   ["lock-open", "lock-open-2"]),
    ("info",       ["circle-info", "alert-info"]),
    # Settings cards (2026-09-09): the canvas' card glyphs.
    ("ruler",      ["ruler"]),
    ("plus",       ["plus", "circle-plus"]),
    ("expand",     ["expand-2", "expand"]),
    ("text",       ["text", "text-a"]),
    ("rotate",     ["rotate", "arrow-rotate-anticlockwise", "history"]),
    ("grid",       ["grid-2", "grid"]),
    ("eyeoff",     ["eye-slash", "eye-closed"]),
    ("utensils",   ["fork-knife"]),
    ("palette",    ["paint-roller-2", "brush"]),
