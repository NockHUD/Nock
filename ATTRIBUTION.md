...
- **Font** `Media/LemonMilk-Regular.otf`, `-Medium.otf`, `-Bold.otf` — LEMON MILK by
  marsnev (https://www.marsnev.com), donationware: free for personal, educational and
  non-profit use. Nock is free software; bundled with the author's permission.
- **Sound** `Media/NockAggro.mp3` (the aggro cue) — a short spoken "aggro"
  generated by the author with fish.audio's text-to-speech; used under
  fish.audio's terms for generated output.
- **Sound** `Media/NockDeadZone.mp3`, `Media/NockMelee.mp3`, `Media/NockInRange.mp3`,
  `Media/NockOutOfRange.mp3` (the spoken range cues) — generated by the author with
  fish.audio text-to-speech, used under fish.audio's terms for generated output.
