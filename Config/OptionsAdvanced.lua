...
A.KEYS = {
  ...
  "hud.react.tabBars.reactShowClipTicks", "hud.react.tabBars.showWindupMark", "hud.react.tabBars.reactShowDelay", "hud.react.tabBars.reactShowBrackets", "hud.react.tabBars.reactShowGcdDivider",
