...
Nock.Defaults = {
  profile = {
    ...
    reactRangeStyle = "compact",  -- Forever Range Finder: "compact" (5 segments, the far block shows the live bracket) | "detailed" (9)
    reactRangeLabels = true,  -- Forever Range Finder: every segment labelled inside itself (off: only the lit one)
