...
Warnings.Catalog = {
  ...
  },
  {
    ...
    mediaSelectors = {
      { key = "warnSlammerSound",       label = "Sound when exposed (the horn)",   mediaType = "sound" },
