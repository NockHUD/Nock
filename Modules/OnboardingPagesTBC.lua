-- Modules/OnboardingPagesTBC.lua
-- The TBC page script for the setup wizard: pages, weave-macro helpers, recap (Modules/Onboarding.lua runs it).
...
local function spellIcon(id)
  return Onboarding.SpellIcon(id)
end
