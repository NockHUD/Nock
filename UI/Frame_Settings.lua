...
function Settings:BuildSidebar()
  ...
  Skin.Icon(glass, "magnifier", "ink3"); Skin.IconSize(glass, 16)   -- 14 broke the ring (the file is a 24-grid)
...
function Settings:PaintMode()
  ...
  for _, pair in ipairs({ { self.modeSimple, not adv }, { self.modeAdvanced, adv } }) do
    ...
    -- (The 2026-09-21 re-apply of the font here did nothing: a same-args
    -- SetFont is a no-op. The first-use blank is handled in Skin.Font by
    -- bouncing the size, 2026-09-23.)
